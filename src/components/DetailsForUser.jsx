  ...
  return (
    <div className="bg-[#FFF4F5] min-h-screen lg:py-24 md:p-12">
      <div className="w-full lg:w-2/4 mx-auto bg-white p-12 flex flex-col gap-12 rounded-lg">
        <div className="flex flex-col lg:flex-row items-center text-center gap-6 lg:gap-0">
          <div className="w-full lg:w-2/3 px-4 flex flex-col gap-8">
            <h1 className="text-xl lg:text-3xl font-bold">{blog?.title}</h1>
